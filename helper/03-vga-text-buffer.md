...
1. [The VGA Text Buffer](#the-vga-text-buffer)
2. [A Rust Module](#a-rust-module)
   1. [Colors](#colors)
   2. [Text Buffer](#text-buffer)
   3. [Printing](#printing)
      1. [Try it out!](#try-it-out)
   4. [Volatile](#volatile)
   5. [Formatting Macros](#formatting-macros)
   6. [Newlines](#newlines)
3. [A Global Interface](#a-global-interface)
   1. [Lazy Statics](#lazy-statics)
   2. [Spinlocks](#spinlocks)
   3. [Safety](#safety)
   4. [A println Macro](#a-println-macro)
   5. [Hello World using `println`](#hello-world-using-println)
   6. [Printing Panic Messages](#printing-panic-messages)
4. [Summary](#summary)
...
![QEMU output with a yellow `Hello W■■rld!` in the lower left corner](../assets/vga-hello.png)
...
![QEMU printing “Hello World!”](../assets/vga-hello-world.png)
...
![QEMU printing “panicked at 'Some panic message', src/main.rs:28:5](../assets/vga-panic.png)
