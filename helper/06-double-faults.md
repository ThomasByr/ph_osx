...
1. [What is a Double Fault?](#what-is-a-double-fault)
   1. [Triggering a Double Fault](#triggering-a-double-fault)
2. [A Double Fault Handler](#a-double-fault-handler)
3. [Causes of Double Faults](#causes-of-double-faults)
   1. [Kernel Stack Overflow](#kernel-stack-overflow)
4. [Switching Stacks](#switching-stacks)
   1. [The IST and TSS](#the-ist-and-tss)
   2. [Creating a TSS](#creating-a-tss)
      1. [Loading the TSS](#loading-the-tss)
   3. [The Global Descriptor Table](#the-global-descriptor-table)
      1. [Creating a GDT](#creating-a-gdt)
      2. [Loading the GDT](#loading-the-gdt)
   4. [The final Steps](#the-final-steps)
5. [A Stack Overflow Test](#a-stack-overflow-test)
   1. [Implementing `_start`](#implementing-_start)
   2. [The Test IDT](#the-test-idt)
   3. [The Double Fault Handler](#the-double-fault-handler)
6. [Summary](#summary)
...
[idt]: 05-cpu-exceptions.md#the-interrupt-descriptor-table
...
![QEMU printing `EXCEPTION: DOUBLE FAULT` and the exception stack frame](../assets/qemu-catch-double-fault.png)
...
[interrupt stack frame]: 05-cpu-exceptions.md#the-interrupt-stack-frame
...
[idt entry]: 05-cpu-exceptions.md#the-interrupt-descriptor-table
...
![QEMU printing `EXCEPTION: DOUBLE FAULT` and a dump of the exception stack frame](../assets/qemu-double-fault-on-stack-overflow.png)
...
[without a test harness]: 04-testing.md#no-harness-tests
    ...
    static ref TEST_IDT: InterruptDescriptorTable = {
        ...
        unsafe {
            idt.double_fault
                ...
                .set_stack_index(ph_osx::gdt::DOUBLE_FAULT_IST_INDEX);
        }
...
use ph_osx::{exit_qemu, QemuExitCode, serial_println};
