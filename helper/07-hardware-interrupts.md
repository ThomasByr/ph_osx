...
1. [Overview](#overview)
2. [The 8259 PIC](#the-8259-pic)
   1. [Implementation](#implementation)
3. [Enabling Interrupts](#enabling-interrupts)
4. [Handling Timer Interrupts](#handling-timer-interrupts)
   1. [End of Interrupt](#end-of-interrupt)
   2. [Configuring the Timer](#configuring-the-timer)
5. [Deadlocks](#deadlocks)
   1. [Provoking a Deadlock](#provoking-a-deadlock)
   2. [Fixing the Deadlock](#fixing-the-deadlock)
6. [Fixing a Race Condition](#fixing-a-race-condition)
7. [The `hlt` Instruction](#the-hlt-instruction)
8. [Keyboard Input](#keyboard-input)
   1. [Reading the Scancodes](#reading-the-scancodes)
   2. [Interpreting the Scancodes](#interpreting-the-scancodes)
   3. [Configuring the Keyboard](#configuring-the-keyboard)
9. [Summary](#summary)
...
[i/o ports]: 04-testing.md#i-o-ports
...
![QEMU printing `EXCEPTION: DOUBLE FAULT` because of hardware timer](../assets/qemu-hardware-timer-double-fault.png)
...
![QEMU printing only a single dot for hardware timer](../assets/qemu-single-dot-printed.png)
...
![QEMU printing consecutive dots showing the hardware timer](../assets/qemu-hardware-timer-dots.gif)
...
[vga spinlock]: 03-vga-text-buffer.md#spinlocks
...
![QEMU output with many rows of hyphens and no dots](../assets/qemu-deadlock.png)
...
[i/o port]: 04-testing.md#i-o-ports
...
![QEMU printing scancodes to the screen when keys are pressed](../assets/qemu-printing-scancodes.gif)
...
![QEMU printing numbers to the screen](../assets/qemu-printing-numbers.gif)
...
![Typing "Hello World" in QEMU](../assets/qemu-typing.gif)
