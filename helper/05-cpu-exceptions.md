...
1. [Overview](#overview)
   1. [The Interrupt Descriptor Table](#the-interrupt-descriptor-table)
2. [An IDT Type](#an-idt-type)
3. [The Interrupt Calling Convention](#the-interrupt-calling-convention)
   1. [Preserved and Scratch Registers](#preserved-and-scratch-registers)
   2. [Preserving all Registers](#preserving-all-registers)
   3. [The Interrupt Stack Frame](#the-interrupt-stack-frame)
   4. [Behind the Scenes](#behind-the-scenes)
4. [Implementation](#implementation)
   1. [Loading the IDT](#loading-the-idt)
...
[vga text buffer lazy static]: 03-vga-text-buffer.md#lazy-statics
...
![QEMU printing `EXCEPTION: BREAKPOINT` and the interrupt stack frame](../assets/qemu-breakpoint-exception.png)
